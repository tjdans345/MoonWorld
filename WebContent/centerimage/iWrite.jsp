					...
					<!-- Table -->
							<section>
								...
								<div class="table-wrapper">
								 <form action="iwritePro.jsp" method= "post" name = "br" enctype="multipart/form-data">
								  <table class="alt">
										<tbody>
											<tr>
												<td>이름</td>
											...
											<tr>
												<td>비밀번호</td> 
												<td><input type="password" name="passwd" placeholder="본인 ID의 비밀번호를 입력하세요." required></td>	
											</tr>
											<tr>
												<td>제목</td>
