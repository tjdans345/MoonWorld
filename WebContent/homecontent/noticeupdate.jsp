		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				...
				<!-- Table -->
							<section>
								<h4>게시판</h4>
							  <form action="nupdatePro.jsp?pageNum=<%=pageNum%>" method="post" name="fr">
								<div class="table-wrapper">
								<input type="hidden" name="num" value="<%=num%>">
									<table class="alt" id="notice">
										<tr>
											<td>이름</td>
											<td><input type="text" name="id" value="<%=DBName%>"></td>
										</tr>
										<tr>
											<td>제목</td>
											<td><input type="text" name="subject" value="<%=DBsuject%>"></td>
										</tr>
										<tr>
											<td>내용</td>
					...
					<div class="12u$" align="center">
										...
										<input type="button" value="목록보기" onclick = "location.href='information.jsp?pageNum=<%=pageNum%>'" />
										</div>
					</div>
